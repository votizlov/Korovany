...
public class LegIk : MonoBehaviour
{
    ...
    [Header("IK Data")] public bool isMounted = false;
    public IkType ikType;

    [Tooltip("Only Used If IkType is Iterative")]
    public int iterations = 4;

    [Header("Segment Data")] public int segmentCount = 4;
    ...
    public class Segment
    {
        ...
        public Vector3 head
        {
            get { return transform.position + transform.forward * halfLength; }
            set { transform.position = value - transform.forward * halfLength; }
        }
